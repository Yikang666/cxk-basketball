...
let _close = false;
let _fsj = false;
var url = '../more/block/static/image/ClickBefore.png';
...
function gameInit() {
    createjs.Sound.registerSound({
        src: "../more/block/static/music/err.mp3",
        id: "err"
    });
    createjs.Sound.registerSound({
        src: "../more/block/static/music/end.mp3",
        id: "end"
    });
    createjs.Sound.registerSound({
        src: "../more/block/static/music/tap.mp3",
        id: "tap"
    });
    gameRestart();
}
